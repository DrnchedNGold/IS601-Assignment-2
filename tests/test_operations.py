...
def test_addition(a: Number, b: Number, expected: Number) -> None:
    ...
    whether they are positive, negative, integers, or floats. 
    
    By using parameterization, we can efficiently test multiple scenarios without redundant code.
    ...
    >>> test_addition(-1, 1, 0)
    """
    # Create an instance of the Operations class and call the 'addition' method with the provided arguments
...
def test_subtraction(a: Number, b: Number, expected: Number) -> None:
    ...
    Parameterization allows for comprehensive testing of multiple cases.
    ...
    >>> test_subtraction(-5, -3, -2)
    """
    # Create an instance of the Operations class and call the 'subtraction' method with the provided arguments
...
def test_multiplication(a: Number, b: Number, expected: Number) -> None:
    ...
    Parameterization enables efficient testing of multiple scenarios in a concise manner.
